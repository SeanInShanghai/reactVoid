                ...
                <div class="main" >
                    ...
                    <div style={{width:'70%', marginLeft:'15%'}}>
                        ...
                        <p class="paragraph"><span class="description" >档案收集</span>
                            <p><span>收集本院文书、科研、基建、设备、会计等具有保存价值的文件及声像、实物材料</span></p>
                        </p>
                        <p class="paragraph"><span class="description" >档案整理</span>
                            ...
                            <p>
                                1.装订、2.分类、3.排列、4.编号、5.编目、6.装盒、7.上架、8.装订目录
                            </p>
                        </p>
                        ...
                        <p class="paragraph"><span class="description" >档案编研</span>
                            ...
                            <p>1.选题、2.选材、3.加工编辑、4.总纂、5.审核</p>
                        </p>
                        <p class="paragraph"><span class="description" >档案利用</span>
                            ...
                            <p>1.档案阅览、2.档案外借、3.电话查档、4.网络查询、5.档案复制供应、6.档案陈列展览、7.档案咨询服务</p>
                        </p>
                    </div>
